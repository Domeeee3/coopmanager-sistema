...
>(({ className, ...props }, ref) => (
  <div className={cn("relative w-full overflow-auto", tableStyles.root)}>
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn(tableStyles.header, "[&_tr]:border-b [&_tr]:border-border", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <tr ref={ref} className={cn(tableStyles.row, "data-[state=selected]:bg-muted", className)} {...props} />
))
